import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/ActionPage-DaTiyQ1T.js").then((m) => m.default || m)
  },
  {
    name: "Cats",
    path: "/Cats",
    ...
    component: () => import("./_nuxt/Cats-U0rAmu9n.js").then((m) => m.default || m)
  },
  {
    name: "ContactsPage",
    path: "/ContactsPage",
    ...
    component: () => import("./_nuxt/ContactsPage-DpHnyP3d.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-BVZHKapV.js").then((m) => m.default || m)
  },
  {
    name: "RunPage",
    path: "/RunPage",
    ...
    component: () => import("./_nuxt/RunPage-DZt6bWcm.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-CfS_HmUg.js").then((m) => m.default || m),
  "footer-bottom": () => import("./_nuxt/FooterBottom-DyWPr4tN.js").then((m) => m.default || m),
  "header-top": () => import("./_nuxt/HeaderTop-CAmqE3f6.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Cuba5FPs.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-M30cOKKM.js").then((r) => r.default || r));
